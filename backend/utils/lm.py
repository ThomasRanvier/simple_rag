...
def rag_streaming_query(context, query, llm, tokenizer):
    ...
    """
    system_prompt = 'Answer the Question below based on the information from the Context section only, d\'ont invent any fact, d\'ont add useless information, answer in a short response and in French.'
